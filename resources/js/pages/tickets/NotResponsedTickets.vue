    ...
    <div class="content-body">
      <div class="content-container">
        ...
        <div class="row mr-0 ml-0 mt-3">
          <div v-if="!Object.keys(list).length" class="text-center text-muted">موردی وجود ندارد</div>
            ...
            <div class="centered-box">
              ...
              <div class="center-div-box">
                <div class="center-div-box-container">
                  <p class="p-top">تاریخ و ساعت: <small>{{item.registered_at}}</small></p>
