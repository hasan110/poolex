...
class StoreController extends Controller
{
    ...
    public function list(Request $request)
    {
        ...
        if($request->search_key){
            ...
            $list = $list->where(function($query) use ($search_key) {
                ...
                ->orWhere('owner_name','like', '%' . $search_key . '%');
            });
        }
        ...
        return Response::success($list ,'لیست فروشگاه ها با موفقیت دریافت شد .');
    }
    ...
    public function ChangeStatus(Request $request)
    {
        ...
        return Response::success($store ,'ویرایش فروشگاه با موفقیت انجام شد .');
    }
